...
"""
curl -d '{"firstname":"jeff", "lastname":"zheng", "username":"jeffreyzheng", "email":"jz079770@gmail.com", "password":"jeffreyzheng" }' -H "Content-Type: application/json" -X POST http://localhost:5000/api/register
"""